...
const faqs = [
  ...
  },
  {
    ...
    a: "학과 전공선택 21학점 요건 자체는 다전공 학생에게도 동일하게 적용됩니다. 다만 단전공 주전공자에게 허용되는 '나머지 10학점을 타과 전선 인정 과목으로 채우는' 방식은 다전공에는 해당하지 않습니다. 복수전공은 학과 개설 전공선택 과목을 추가로 이수해 최소 39학점을 만족해야 하고, 부전공은 전공교과목 21학점 이상(전공필수 12학점 포함)을 이수해야 하며, 두 경우 모두 타과 전선 인정 과목이 아니라 다전공 이수 자체로 요건을 채웁니다."
  },
  {
  ...
  },
  {
    ...
    a: "정해진 주기 없이 비정기적으로 업데이트됩니다. 학과가 학생 의견을 수렴하고 검토를 거쳐 반영하므로, 실제로 수강한 타과 과목이 인정 목록에 없다면 학과에 문의해 반영을 요청할 수 있습니다."
  },
  {
  ...
  },
  {
    ...
    a: "수강 후 성적이 나오면 <strong>MySNU &gt; 수업/성적 &gt; 성적 &gt; 교과구분변경신청</strong>에서 전공선택 학점으로 인정받을 수 있습니다. 각 학기가 끝날 때마다 신청할 필요는 없고, <strong>졸업 전까지만</strong> 변경신청을 완료하면 됩니다."
  },
  {
